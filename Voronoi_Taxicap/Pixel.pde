class Pixel {
  ...
  void obtenerMarcadorCercano(Point nuevo_marcador) {
    ...
    if(this.marcador_cercano != null)
      distancia_actual = distTaxicap(this.marcador_cercano.x, this.marcador_cercano.y, this.x, this.y);
    float distancia_nueva = distTaxicap(nuevo_marcador.x, nuevo_marcador.y, this.x, this.y);
